...
\end{array} \]
Die Leistung an $R101$ ist am grössten, da die anderen Widerstände um Grössenordnungen hochohmiger sind. Für $R101$ wird ein SMD Widerstand der Baugrösse 1206 verwendet. Für alle anderen Widerstände genügt die Baugrösse 0805. 
%
\[ \begin{array}{l}
...
\end{array} \]
%
Für die Dimensionierung von $R105$ wird der Basisstrom vom $V102$ vernachlässigt. Als Kollektorstrom $I_{C_{V101}}$ werden $0.2 mA$ festgelegt. 
\[ \begin{array}{l}
R105_{max} 
